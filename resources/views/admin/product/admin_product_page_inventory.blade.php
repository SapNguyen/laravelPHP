  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>List of Inventory products</h1>
          </div>
          <div class="col-sm-6">
            ...
            <div class="col-12">
                <div class="card card-info">
                    <div class="card-header">
                        <form method="get" action="{{ route('a.revenue.list.0') }}" style="width: 50%;">
                                ...
                                <div style="width: 100%;">
                                    <div class="dataTables_paginate paging_simple_numbers" id="paginate">
                                        <div style="float: left">
                                            <span>Showing {{ $product->firstItem() }} to {{ $product->lastItem() }} of brands</span>
                                        </div>
