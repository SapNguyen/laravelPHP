        ...
        <tbody>
            @foreach($product_orders as $rp)
                <tr>
                    ...
                    {{-- <td>
                      <input type="radio" name=rddmtrangthai value=1 @if ($product_order->order_status == 1)  checked  @endif>Xác nhận 
                      <input type="radio" name=rddmtrangthai value=0 @if ($product_order->order_status == 0) checked @endif>Chưa xác nhận 
                    </td> --}}
