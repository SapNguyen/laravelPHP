...
<body class="hold-transition sidebar-mini layout-fixed">
  ...
  <div class="wrapper">
              ...
              <div class="col-12">
                  <div class="card card-info">
                      <div class="card-header">
                          <form method="get" action="{{ route('a.revenue.list.2') }}" style="width: 50%;">
                          ...
                          <br>
                        <h3 class="card-title">Nhập ngày đã hoàn thành để tìm kiếm</h3>
    ...
    @php
        $totalOrderValue += $order->order_value;
    @endphp
@endforeach
<h1>Tổng lợi nhuận: {{ number_format($totalOrderValue) }} VNĐ</h1>
