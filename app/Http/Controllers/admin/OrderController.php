...
class OrderController extends Controller
{
    ...
    public function index()
    {
        ...
        //     $get = DB::table('order')->where('order_status', '=', 1)->where('validated_date', '=', $searchName)->orderByRaw('validated_date DESC')->paginate(10);
        // } else {
        //     $count = order::where('order_status', '=', 1)->count('order_id');
        //     $get = DB::table('order')->where('order_status', '=', 1)->orderByRaw('validated_date DESC')->paginate(10);
        // }
        // // $count = order::where('order_status', '=', 1)->count('order_id');
        ...
        if ($response->successful()) {
            ...
            $orders = collect($responseData['orders']['data']);
    ...
    public function index_unconfimred()
    {
        ...
        //     $get = DB::table('order')->where('order_status', '=', 0)->where('created_date', '=', $searchName)->paginate(10);
        // } else {
        //     $count = order::where('order_status', '=', 0)->count('order_id');
        //     $get = DB::table('order')->where('order_status', '=', 0)->paginate(10);
        // }
        // // $count = order::where('order_status', '=', 0)->count('order_id');
    ...
    public function index_canceled()
    {
        ...
        //     $get = DB::table('order')->where('order_status', '=', -1)->where('canceled_date', '=', $searchName)->paginate(10);
        // } else {
        //     $count = order::where('order_status', '=', -1)->count('order_id');
        //     $get = DB::table('order')->where('order_status', '=', -1)->paginate(10);
        // }
    ...
    public function index_finished()
    {
        ...
        //     $get = DB::table('order')->where('order_status', '=', 2)->where('completion_date', '=', $searchName)->paginate(10);
        // } else {
        //     $count = order::where('order_status', '=', 2)->count('order_id');
        //     $get = DB::table('order')->where('order_status', '=', 2)->paginate(10);
        // }
        // // $count = order::where('order_status', '=', 2)->count('order_id');
    ...
    public function detail($order_id)
    {
        ...
        // }
        // // $product_orders=product::join('product_order','product_order.product_id','=','product.product_id')->join('order','order.order_id','=','product_order.order_id')->join('member','order.mem_id','=','member.mem_id')->join('product_size_color','product.product_id','=','product_size_color.product_id')->where('order.order_id','=',$order_id);
        ...
        $response = Http::get("https://s25sneaker.000webhostapp.com/api/admin/detail/{$order_id}");
        ...
        if ($response->successful()) {
            ...
            $product_orders = $responseData['product_orders'];

            $product_order = $responseData['product_order'];
    ...
    public function edit($order_id)
    {
        ...
        $response = Http::get("https://s25sneaker.000webhostapp.com/api/admin/edit/{$order_id}");
    ...
    public function delorder(Request $request)
    {
        ...
        $get = $request->all();
        $response = Http::post('https://s25sneaker.000webhostapp.com/api/delorder', $get);
        if ($response->successful()) {
    ...
    public function postedit($order_id)
    {
        try {
            ...
            $response = Http::post("https://s25sneaker.000webhostapp.com/api/admin/edit/{$order_id}");
    ...
    public function canceledit($order_id)
    {
        try {
            ...
            $response = Http::post("https://s25sneaker.000webhostapp.com/api/cancel_edit/{$order_id}");
