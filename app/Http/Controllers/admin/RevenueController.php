...
class RevenueController extends Controller
{
    public function show()
    {
        ...
        $response = Http::get('https://s25sneaker.000webhostapp.com/api/admin/revenue');
    ...
    public function homepage()
    {
        ...
        $response = Http::get('https://s25sneaker.000webhostapp.com/api/admin_page');

        // Kiểm tra nếu yêu cầu thành công (status code 200)
        if ($response->successful()) {
            $responseData = $response->json();

            $trendName = $responseData['trendName'];
            $trendSale = $responseData['trendSale'];
            $saleBrand = $responseData['saleBrand'];
            $saleQuan = $responseData['saleQuan'];
            $topsale = $responseData['topsale'];
